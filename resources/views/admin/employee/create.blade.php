        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="createEmployee" action=" {{ route('admin.employee.store') }} " method="POST" enctype="multipart/form-data" class="was-validated">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" type="date" id="hired_date" name="hired_date" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="national_id" name="national_id" type="number" class="form-control" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="department_name" name="department_name" type="text" class="form-control" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="yearly_holiday" name="yearly_holiday" type="text" class="form-control" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
